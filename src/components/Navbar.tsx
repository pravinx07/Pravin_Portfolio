    ...
    <nav className={`fixed top-0 left-0 w-full z-[1000] transition-all duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <button className="p-2 rounded-full text-slate-400 hover:text-primary hover:bg-dark-lighter transition-all">
            <Moon size={20} />
          </button>
        </div>
      ...
      {/* Mobile Menu */}
      <div className={`fixed top-0 right-0 w-3/4 h-screen bg-dark-surface z-[1001] flex flex-col justify-center items-center gap-8 transition-transform duration-500 ease-in-out md:hidden ${
